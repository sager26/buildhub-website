      ...
      <div className="container-x">
        <div className="mb-14 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <Reveal delay={0.08}>
              <h2 className="mt-5 max-w-xl font-display text-4xl font-bold leading-[1.05] tracking-tight text-gray-900 md:text-5xl">
                {WHY.title}
              </h2>
            </Reveal>
          </div>
            ...
            <motion.div key={item.title} variants={fadeUp}>
              ...
              >
                <div className="flex h-full flex-col rounded-2xl border border-gray-200 bg-white p-7 shadow-sm transition-all duration-300 hover:border-brand-green/40 hover:shadow-md">
                  ...
                  <span className="mt-6 text-xs font-medium tabular-nums text-gray-200">
                    0{i + 1}
                  </span>
                </div>
              </TiltCard>
